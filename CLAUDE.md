...
| NexSpend proje kaydı (meta + master + V1 ADR'ları) | `C:\Users\batuh\dev\knowledge\projects\nexspend.md` → linkler `nexspend-master.md` + `decisions-log/2026-05-11-v1-*.md` | ↑ Proje Özeti, ↑ Çapraz Mimari İlkeler |

...
export class PrismaService implements OnModuleInit, OnModuleDestroy {
  ...
  get transactionTag() {
    return this._client.transactionTag;
  }
  get transaction() {
    return this._client.transaction;
  }
  get recurringTransaction() {
    return this._client.recurringTransaction;
  }
  get budget() {
    return this._client.budget;
  }
  get debt() {
    return this._client.debt;
  }
  get debtInstallment() {
    return this._client.debtInstallment;
  }
  get debtPayment() {
    return this._client.debtPayment;
  }
  get subscription() {
    return this._client.subscription;
  }
  get receipt() {
    return this._client.receipt;
  }
  get receiptItem() {
  ...
  get inflationRate() {
    return this._client.inflationRate;
  }
  get categoryInflationMap() {
    return this._client.categoryInflationMap;
  }
  get portfolioAsset() {
    return this._client.portfolioAsset;
  }
  get portfolioTx() {
    return this._client.portfolioTx;
  }
  get exchangeRate() {
    return this._client.exchangeRate;
  }
  get insight() {
    return this._client.insight;
  }
  get familyGroup() {
    return this._client.familyGroup;
  }
  get familyMember() {
    return this._client.familyMember;
  }
  get familyInvite() {
    return this._client.familyInvite;
  }
  get sharedBudget() {

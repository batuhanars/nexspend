...
class DateFormatter {
  ...
  /// 15 Oca 2026, 14:30
  static String formatFull(DateTime date) => _fullDateTime.format(date);
  ...
  static String formatGroupHeader(DateTime date) {
    ...
    if (d.year == now.year) return _dayMonth.format(date).toUpperCase();
    return _dayMonthYear.format(date).toUpperCase();
  }

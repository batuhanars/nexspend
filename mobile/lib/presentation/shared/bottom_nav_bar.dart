...
class _AppShellState extends State<AppShell> with WidgetsBindingObserver {
  ...
  static const int kCoachMarkVersion = 3;
  ...
  void _showCoachMark() {
    ...
    TutorialCoachMark(
      targets: [
        ...
        // Step 2 — Reports icon (app bar, top of screen → content below)
        TargetFocus(
          identify: 'reports',
        ...
        // Step 5 — Swipe to delete (off-screen spotlight)
        TargetFocus(
          identify: 'swipe',
